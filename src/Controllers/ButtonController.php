 ...
 */
function sanitizeButtonText(object $item, string $link): string
{
 ...
 */
function getButtonVariant(object $item): string
{
 ...
 */
function buildButtonClasses(object $item): array
{
    $classes = [];
 ...
 */
function buildButtonAttributes(string $link, bool $target, bool $isExternal, array $classes, string $text): array
{
    $attrs = [];
 ...
 */
function parseButtonCustomAttributes(object $item): array
{
    $attrs = [];
