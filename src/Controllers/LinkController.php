...
return function (object $item): array {
     ...
     */
    $sanitizeText = function (object $item, ?object $page, string $url): string {
     ...
     */
    $buildCssClasses = function (object $item, bool $isCurrentPage, bool $isExternal): array {
        $classes = [];
     ...
     */
    $parseCustomAttributes = function (object $item): array {
        $attrs = [];
     ...
     */
    $buildLinkAttributes = function (string $url, bool $isTargetBlank, bool $isExternal, array $classes, string $text) use ($parseCustomAttributes, $item): array {
